package com.week02_netty.netty.netty;

import com.alibaba.fastjson.JSON;
import com.week02_netty.netty.work.HttpClientPoolUtil;
import com.week02_netty.netty.work.HttpClientResult;
...
public class HttpHandler extends ChannelInboundHandlerAdapter {
    ...
    private void handlerTest(FullHttpRequest fullRequest, ChannelHandlerContext ctx, String body) {
        ...
        try {
             ...
             * 是使用 httpclient/okhttp 作为客户端 转发到 业务服务吗？
             */
            HttpClientResult httpClientResult = HttpClientPoolUtil.doGet("http://localhost:8801");
            String value = JSON.toJSONString(httpClientResult);
